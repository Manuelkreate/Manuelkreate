...
### 🛠️ My Toolbox
* **The Languages:** SQL (Server/Postgres), Python.
...
* **The Insight:** Discovered that friction and growth are inversely related; reducing friction in high-impact services like Lending and Airtime is critical for value creation.
